...
function cifrar(){
    ...
    if(input == ""){
        Swal.fire({
            icon: "info",
            title:"Campo vacío, por favor escribe texto a codificar!"});
        return};
...
function descifrar(){
    ...
    if(input == ""){
        Swal.fire({
            icon: "info",
            title:"Campo vacío, por favor escribe texto a decodificar!"});
        return
    }
...
function copyToClipBoard() {
    ...
    if(document.getElementById("output_text").value == ""){
        Swal.fire({
            icon: "info",
            title:"Campo vacío, no hay texto para copiar",
            });
        return};
    document.getElementById('output_text').value = "";
    Swal.fire({
